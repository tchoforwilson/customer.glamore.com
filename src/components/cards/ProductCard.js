      ...
      <figcaption className="product-card__details">
        <div className="flex justify-between">
          ...
          <div className="product-card__price">
            <span>{currencyFormatter(product.currency, product.price)}</span>
          </div>
        </div>
        <div className="product-card__rating">
          <span className="product-card__rating-text">Avg Rating:</span>
          <svg
            ...
            stroke="currentColor"
            data-slot="icon"
            class="w-6 h-6 icon product-card__rating-icon"
          >
            <path
          ...
          <span className="product-card__rating-quantity">
